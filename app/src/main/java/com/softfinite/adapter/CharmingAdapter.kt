...
import kotlinx.android.synthetic.main.item_charming_list.view.*

/**
 * Created by Softfinite (Viv'Ek Chodvadiya) on 13-Jun-18.
 */

class CharmingAdapter(internal var context: Context) : RecyclerView.Adapter<CharmingAdapter.MyViewHolder>() {

//    private var data: MutableList<Heros.Hero>? = ArrayList<Heros.Hero>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: CharmingAdapter? = null
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_charming_list, parent, false)
...
//        }
////
        holder.tvCharmingIndex!!.setText("" + (position + 1))
//
...
//        return data!!.size
    ...
    class MyViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        val tvCharmingIndex = v.tvCharmingIndex
        val imgCharmingTop = v.imgCharmingTop
        val tvCharmingName = v.tvCharmingName
        val tvCharmingPoints = v.tvCharmingPoints
        val imgCharmingHeart = v.imgCharmingHeart
    }
}
