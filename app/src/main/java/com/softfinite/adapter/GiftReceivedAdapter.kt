...
class GiftReceivedAdapter(internal var context: Context) : RecyclerView.Adapter<GiftReceivedAdapter.MyViewHolder>() {

//    private var data: MutableList<Heros.Hero>? = ArrayList<Heros.Hero>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: GiftReceivedAdapter? = null
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_gift_received, parent, false)
