...
import kotlinx.android.synthetic.main.item_private_videos.view.*

/**
 * Created by Softfinite (Viv'Ek Chodvadiya) on 13-Jun-18.
 */

class PrivateVideosAdapter(internal var context: Context) : RecyclerView.Adapter<PrivateVideosAdapter.MyViewHolder>() {

//    private var data: MutableList<Heros.Hero>? = ArrayList<Heros.Hero>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: PrivateVideosAdapter? = null
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_private_videos, parent, false)
...
//        return data!!.size
    ...
    class MyViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        val imgPrivateVideo = v.imgPrivateVideo
    }
}
