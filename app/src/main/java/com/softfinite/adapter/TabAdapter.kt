...
import kotlinx.android.synthetic.main.item_tab_list.view.*

/**
 * Created by Softfinite (Viv'Ek Chodvadiya) on 13-Jun-18.
 */

class TabAdapter(internal var context: Context) : RecyclerView.Adapter<TabAdapter.MyViewHolder>() {

//    private var data: MutableList<Heros.Hero>? = ArrayList<Heros.Hero>()

    internal var imageLoader: ImageLoader
    internal var myEventAdapter: TabAdapter? = null
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_tab_list, parent, false)
